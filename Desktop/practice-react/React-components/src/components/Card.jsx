...
export const Card = ({ active, text, description }) => {
    ...
    return (
      <div className="bg-white shadow-lg rounded-lg overflow-hidden m-6 transition-transform transform hover:scale-105">
        <img 
          src={images[active]} 
          alt={`Card ${active}`} 
        ...
        />
        <div className="p-4">
            <p className="text-slate-500 mb-4 text-2xl">{text}</p>
