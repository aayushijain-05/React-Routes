...
const cardData = [
    ...
    },
    {
      active: 4,
      text: "Cruise",
      description: "Discover the ultimate way to explore the world with our spectacular cruise offerings. Whether you're looking for a family vacation, or an adventure with friends, our cruises provide a unique experience on the open sea.",
    },
    {
      active: 5,
      text: "Activites",
      description: "Unleash your sense of adventure with our wide range of activities designed to create unforgettable experiences. Whether you're seeking cultural explorations, or relaxing leisure pursuits, we have something for everyone.",
    },
  ];
export const CardComponent = () => {
  return (
    <div>
        <div className="grid grid-cols-3 items-center p-2 gap-6 w-full ">
